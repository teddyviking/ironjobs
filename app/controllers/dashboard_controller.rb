class DashboardController < ApplicationController
	...
	def set_admin_notifications
		flash[:companies] = create_notification_message(@pending_companies) if !@pending_companies.empty?
		flash[:job_posts] = create_notification_message(@pending_job_posts) if !@pending_job_posts.empty? 
